#!/usr/bin/env python3
#该脚本兼容了config.json文件的配置，支持设置测试结构的输出路径
import subprocess
import csv
...
conc_prompts = [(1, 256), (2, 256), (4, 256), (8, 256), (32, 256), (64, 256), (128, 256)]

# Returns a list of test cases generated by Cartesian product.
...
def run_benchmark(model_path: str, model_name: str, input_len: int, output_len: int, max_concurrency: int, num_prompts: int) -> str:
    cmd = [
        "vllm", "bench", "serve",
        "--model", model_path,
